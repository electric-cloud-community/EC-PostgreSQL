...
// PostgreSQLConfigList.java --
//
// PostgreSQLConfigList.java is part of ElectricCommander.
//
...
public class PostgreSQLConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, PostgreSQLConfigInfo> m_configInfo =
        new TreeMap<String,  PostgreSQLConfigInfo>();
    ...
    public void addConfig(
            ...
            String configUrl)
    {
        m_configInfo.put(configName, new PostgreSQLConfigInfo(configUrl));
    }
    ...
    private class PostgreSQLConfigInfo
    {
        ...
        public  PostgreSQLConfigInfo(String url)
        {
            m_url = url;
        }
    }
