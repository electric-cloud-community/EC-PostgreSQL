...
/**
 * EC-PostgreSQL Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private PostgreSQLConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "PostgreSQL Configurations", "All Configurations");
        m_configList = new PostgreSQLConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        PostgreSQLConfigListLoader loader = new PostgreSQLConfigListLoader(
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the PostgreSQL configuration '"
                            + configName + "'?") {
