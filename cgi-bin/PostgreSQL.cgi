...
# PostgreSQL.cgi -
#
# Get/set EC-PostgreSQL configuration info for UI
#
...
################################
# getCfgList - Return the list of configurations from PostgreSQL
#
# Arguments:
#   -
#
...
sub getCfgList {
    ...
    my $gcfg = new ElectricCommander::PropDB($::ec,"/projects/@PLUGIN_NAME@/PostgreSQL_cfgs");
    ...
    foreach my $cfg (keys  %cfgs) {
      #  my $url = $gcfg->getCol("$cfg/PostgreSQL_url");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
